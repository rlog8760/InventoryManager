...
public class InventoryProvider extends ContentProvider {
    ...
    private Uri insertInventoryItem(Uri uri, ContentValues values) {
        ...
        Integer productQuantity = values.getAsInteger(InventoryContract.InventoryEntry.COLUMN_INVENTORY_ITEM_QUANTITY);
    ...
    private int updateInventoryItem(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(InventoryContract.InventoryEntry.COLUMN_INVENTORY_ITEM_QUANTITY)) {
            ...
            Integer productQuantity = values.getAsInteger(InventoryContract.InventoryEntry.COLUMN_INVENTORY_ITEM_QUANTITY);
            if (productQuantity == null) {
                throw new IllegalArgumentException("Inventory item requires a quantity");
            }
        }
